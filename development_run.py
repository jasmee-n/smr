...
REPORT_OUTPUT_DIRECTORY = PROJECT_ROOT / 'reports' / 'dev_reports'
...
for patient in patients:
    ...
    print(f'STARTING: {patient["patient_id"]}', flush = True)
    ...
    report_path = REPORT_OUTPUT_DIRECTORY / f"{patient['patient_id']}.pdf"
    save_report_as_pdf(report, report_path)

    print(f'COMPLETED: {patient["patient_id"]}', flush = True)
